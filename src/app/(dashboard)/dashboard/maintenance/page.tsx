    ...
    <div>
      ...
      <div className="flex items-center gap-4 mb-8">
        <div className="w-12 h-12 rounded-xl bg-blue-50 flex items-center justify-center">
          <Wrench className="w-6 h-6 text-blue-600" strokeWidth={1.75} />
        </div>
        <div>
          <h1 className="text-2xl font-bold text-[#04111f]">Maintenance</h1>
          <p className="text-[13px] text-slate-500 mt-0.5">
            Vessel maintenance scheduling &amp; tracking
          </p>
        </div>
      </div>
